package com.withintime.in.currencycalculation.controller;

import com.withintime.in.currencycalculation.facade.CurrencyExchangeProxy;
...
public class CurrencyCalculationController {
    ...
    public CalculatedAmount calculateAmount(@PathVariable String from,
    ...
    public CalculatedAmount calculateAmountFeign(@PathVariable String from,
                                            @PathVariable String to,
                                            @PathVariable BigDecimal quantity){
